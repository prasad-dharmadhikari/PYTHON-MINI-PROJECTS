...
answer = input("You are on a dirt road, it has come to an end and you can go left or right.Which way would you like "
               "to go? ").lower()
if answer == "left":
    answer = input("You come to a river, you can walk around it or swim accross? Type walk to walk around and swim to "
                   "swim accross. ").lower()
    if answer == "swim":
        print("You swam accross, and were eaten by the alligator.")
    elif answer == "walk":
